...
2. **Mutli-User Wallets, Social Recovery:**  Semi-fungible NFTs enable multiple copies of keys to be minted. This allows multiple EOAs or CAs to control the same permission, and enables the wallet owner to mint multiple permissions used by different actors.
